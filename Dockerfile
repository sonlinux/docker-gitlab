# This is a base image for gitlab ci-cd server.
...
LABEL \
    maintainer="mukomalison@gmail.com" \
    org.label-schema.schema-version="1.0" \
    org.label-schema.build-date=${BUILD_DATE} \
    org.label-schema.name=gitlab \
    org.label-schema.vendor=damagehead \
    org.label-schema.url="https://github.com/sonlinux/docker-gitlab" \
    org.label-schema.vcs-url="https://github.com/sonlinux/docker-gitlab.git" \
